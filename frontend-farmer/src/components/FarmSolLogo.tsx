    ...
    >
      ...
      >
        <defs>
          ...
          {/* Farmer Gradient */}
          <linearGradient id="farmerGrad" x1="0%" y1="0%" x2="0%" y2="100%">
        ...
        {/* Golden Sun */}
        <circle cx="100" cy="78" r="32" fill="url(#sunGrad)" />
        ...
        {/* Agricultural Fields (Green Arc Terraces) */}
        <path
          d="M 16 115 C 45 100, 100 100, 184 115 L 184 150 C 140 185, 60 185, 16 150 Z"
          fill="url(#fieldGrad)"
        />
        <path
          d="M 28 132 C 60 120, 120 120, 172 132"
          stroke="#ffffff"
          strokeWidth="3.5"
          strokeLinecap="round"
          fill="none"
        ...
        />
        <path
          d="M 45 150 C 75 142, 125 142, 155 150"
          stroke="#ffffff"
          strokeWidth="3"
          strokeLinecap="round"
          fill="none"
        ...
        >
          ...
          <span style={{ position: 'relative', display: 'inline-flex', alignItems: 'center', justifyContent: 'center' }}>
            ...
            <span style={{ position: 'relative', display: 'inline-flex', alignItems: 'center', margin: '0 1px' }}>
              ...
              >
                <path
                  d="M12 3C7 3 4 8 4 13C4 18 8 21 13 21C18 21 21 16 21 11C21 10 20 5 12 3Z"
                  fill="#15803d"
                  opacity="0.2"
                />
                <path
                  d="M6 15C10 15 17 12 18 6C12 7 7 11 6 15Z"
                  fill="#22c55e"
                />
              </svg>
            </span>
      ...
      {/* Tagline: Smart Procurement. Better Farming. */}
      {showTagline && (
        <div
          style={{
            marginTop: 4,
            fontSize: size === 'sm' ? '0.72rem' : size === 'md' ? '0.85rem' : '0.98rem',
            fontWeight: 600,
            color: taglineColor,
            letterSpacing: '0.2px'
          }}
