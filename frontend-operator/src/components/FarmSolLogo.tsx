...
export const FarmSolLogo: React.FC<FarmSolLogoProps> = ({
  ...
  return (
    ...
    >
      ...
      >
        <defs>
          <radialGradient id="sunGradOp" cx="50%" cy="50%" r="50%">
            <stop offset="0%" stopColor="#fde047" />
            <stop offset="60%" stopColor="#eab308" />
            <stop offset="100%" stopColor="#ca8a04" />
          </radialGradient>
          <linearGradient id="fieldGradOp" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="#22c55e" />
            <stop offset="50%" stopColor="#16a34a" />
            <stop offset="100%" stopColor="#15803d" />
          </linearGradient>
          <linearGradient id="farmerGradOp" x1="0%" y1="0%" x2="0%" y2="100%">
        ...
        <circle cx="100" cy="78" r="32" fill="url(#sunGradOp)" />
        ...
        <path d="M 16 115 C 45 100, 100 100, 184 115 L 184 150 C 140 185, 60 185, 16 150 Z" fill="url(#fieldGradOp)" />
